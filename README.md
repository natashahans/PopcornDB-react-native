...
PopcornDB is a React Native movie discovery app built with Expo. It allows users to browse trending movies, search content, view details, and save items to a personal watchlist using live data from the TMDB API.
...
constants/    Theme and color settings
